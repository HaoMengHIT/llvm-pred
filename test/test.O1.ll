...
for.end:
  ...
  br i1 %cmp2, label %for.body5.preheader, label %if.else
...
for.end14:                                        ; preds = %for.body5
  %add.lcssa = phi i32 [ %add, %for.body5 ]
  store i32 %add.lcssa, i32* %Bound, align 4, !tbaa !1
...
if.else:                                          ; preds = %for.end
  ...
  br i1 %cmp2045, label %for.body21.preheader, label %for.end27

for.body21.preheader:                             ; preds = %if.else
  br label %for.body21

for.body21:                                       ; preds = %for.body21.preheader, %for.body21
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %for.body21 ], [ 0, %for.body21.preheader ]
  %13 = trunc i64 %indvars.iv49 to i32
  %mul22 = mul nsw i32 %13, %13
  ...
  %exitcond1 = icmp eq i32 %lftr.wideiv, %rem44
  br i1 %exitcond1, label %for.end27.loopexit, label %for.body21

for.end27.loopexit:                               ; preds = %for.body21
  br label %for.end27

for.end27:                                        ; preds = %for.end27.loopexit, %if.else
  %14 = load %struct._IO_FILE** @stderr, align 8, !tbaa !5
  %15 = call i64 @fwrite(i8* getelementptr inbounds ([7 x i8]* @.str2, i64 0, i64 0), i64 6, i64 1, %struct._IO_FILE* %14) #5
  br label %if.end
